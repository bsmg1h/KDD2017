...
add_previous_y <- function(train_model, y_data) {
  train_model %>% 
  ...
  colnames(result)[(ncol(result)-5):ncol(result)] <- c("y_1", "y_2", "y_3", "y_4", "y_5", "y_6")
  return(result)
}
train_model = add_previous_y(train_model, y_data)
# for the test days the data of "y_1", "y_2", "y_3", "y_4", "y_5", "y_6" are incomplete
...
# which are : "y_1", "y_2", "y_3", "y_4", "y_5", "y_6"
test_model = add_previous_y(test_model, y_data)
```
# Ouput
```{r}
# output files
