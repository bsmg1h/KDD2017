...
train_weather = read.csv("weather (table 7)_training_update.csv") # there are 8 times 999017 unusual values : that needs to be replaced
...
join_link_information <- function(links, link_information) {
  link_information = link_information %>% select(link_id, length, width, in_top, out_top)
...
join_weather <- function(links, weather) {
  ...
  weather = mutate(weather, start_date = date, weather_group = as.numeric(hour)) %>% select(-date, -hour)
  # links = left_join(links, weather, by = c("start_date" = "date", "weather_group" = "hour"))
  links = left_join(links, weather, by = c("start_date", "weather_group"))
...
```
# add information about previous day_time_group, including in and out links information
```{r}
...
add_previous <- function(train_model, y_data, mean_travel_time_data) {
  # can also be used on test_model
  train_model %>% 
    # general processing
    ...
    # for in and out links
    separate(in_top, into = c("in_link_1", "in_link_2"), sep = ",") %>%
    separate(out_top, into = c("out_link_1", "out_link_2"), sep = ",") %>%
    mutate(in_link_1 = as.numeric(in_link_1), in_link_2 = as.numeric(in_link_2),
           out_link_1 = as.numeric(out_link_1), out_link_2 = as.numeric(out_link_2)) %>%
    # lag y of the link
    ...
    # lag mean_travel_time of the link
    ...
    left_join(mean_travel_time_data, 
              by = c("link_id" = "link_id", "previous_date" = "start_date", "previous_dtg_6" = "day_time_group")) -> result
  colnames(result)[(ncol(result)-11):ncol(result)] <- c("y_1", "y_2", "y_3", "y_4", "y_5", "y_6",
                                                        "mtt_1", "mtt_2", "mtt_3", "mtt_4", "mtt_5", "mtt_6")
    # in link 1
  result %>%
    left_join(y_data, by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_1" = "day_time_group")) %>%
    left_join(y_data, by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_2" = "day_time_group")) %>%
    left_join(y_data, by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_3" = "day_time_group")) %>%
    left_join(y_data, by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_4" = "day_time_group")) %>%
    left_join(y_data, by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_5" = "day_time_group")) %>%
    left_join(y_data, by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_6" = "day_time_group")) %>%
    # lag mean_travel_time of the link
    left_join(mean_travel_time_data, 
              by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_1" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_2" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_3" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_4" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_5" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("in_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_6" = "day_time_group")) -> result
  colnames(result)[(ncol(result)-11):ncol(result)] <- c("in_link_1_y_1", "in_link_1_y_2", "in_link_1_y_3", 
                                                        "in_link_1_y_4", "in_link_1_y_5", "in_link_1_y_6",
                                                        "in_link_1_mtt_1", "in_link_1_mtt_2", "in_link_1_mtt_3",
                                                        "in_link_1_mtt_4", "in_link_1_mtt_5", "in_link_1_mtt_6")
  # in link 2
  result %>%
    left_join(y_data, by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_1" = "day_time_group")) %>%
    left_join(y_data, by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_2" = "day_time_group")) %>%
    left_join(y_data, by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_3" = "day_time_group")) %>%
    left_join(y_data, by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_4" = "day_time_group")) %>%
    left_join(y_data, by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_5" = "day_time_group")) %>%
    left_join(y_data, by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_6" = "day_time_group")) %>%
    # lag mean_travel_time of the link
    left_join(mean_travel_time_data, 
              by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_1" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_2" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_3" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_4" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_5" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("in_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_6" = "day_time_group")) -> result
  colnames(result)[(ncol(result)-11):ncol(result)] <- c("in_link_2_y_1", "in_link_2_y_2", "in_link_2_y_3", 
                                                        "in_link_2_y_4", "in_link_2_y_5", "in_link_2_y_6",
                                                        "in_link_2_mtt_1", "in_link_2_mtt_2", "in_link_2_mtt_3",
                                                        "in_link_2_mtt_4", "in_link_2_mtt_5", "in_link_2_mtt_6")
  # out link 1
  result %>%
    left_join(y_data, by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_1" = "day_time_group")) %>%
    left_join(y_data, by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_2" = "day_time_group")) %>%
    left_join(y_data, by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_3" = "day_time_group")) %>%
    left_join(y_data, by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_4" = "day_time_group")) %>%
    left_join(y_data, by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_5" = "day_time_group")) %>%
    left_join(y_data, by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_6" = "day_time_group")) %>%
    # lag mean_travel_time of the link
    left_join(mean_travel_time_data, 
              by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_1" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_2" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_3" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_4" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_5" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("out_link_1" = "link_id", "previous_date" = "start_date", "previous_dtg_6" = "day_time_group")) -> result
  colnames(result)[(ncol(result)-11):ncol(result)] <- c("out_link_1_y_1", "out_link_1_y_2", "out_link_1_y_3", 
                                                        "out_link_1_y_4", "out_link_1_y_5", "out_link_1_y_6",
                                                        "out_link_1_mtt_1", "out_link_1_mtt_2", "out_link_1_mtt_3",
                                                        "out_link_1_mtt_4", "out_link_1_mtt_5", "out_link_1_mtt_6")
  # out link 2
  result %>%
    left_join(y_data, by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_1" = "day_time_group")) %>%
    left_join(y_data, by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_2" = "day_time_group")) %>%
    left_join(y_data, by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_3" = "day_time_group")) %>%
    left_join(y_data, by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_4" = "day_time_group")) %>%
    left_join(y_data, by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_5" = "day_time_group")) %>%
    left_join(y_data, by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_6" = "day_time_group")) %>%
    # lag mean_travel_time of the link
    left_join(mean_travel_time_data, 
              by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_1" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_2" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_3" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_4" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_5" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_6" = "day_time_group")) -> result
  colnames(result)[(ncol(result)-11):ncol(result)] <- c("out_link_2_y_1", "out_link_2_y_2", "out_link_2_y_3", 
                                                        "out_link_2_y_4", "out_link_2_y_5", "out_link_2_y_6",
                                                        "out_link_2_mtt_1", "out_link_2_mtt_2", "out_link_2_mtt_3",
                                                        "out_link_2_mtt_4", "out_link_2_mtt_5", "out_link_2_mtt_6")
...
add_in_info <- function(train_model, y_data, mean_travel_time_data) {
  train_model %>%
    separate(in_top, into = c("in_link_1", "in_link_2"), sep = ",") %>%
    separate(out_top, into = c("out_link_1", "out_link_2"), sep = ",") %>%
    mutate(in_link_1 = as.numeric(in_link_1), in_link_2 = as.numeric(in_link_2),
  ...
  result %>%
    ...
    left_join(mean_travel_time_data, 
              by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_5" = "day_time_group")) %>%
    left_join(mean_travel_time_data, 
              by = c("out_link_2" = "link_id", "previous_date" = "start_date", "previous_dtg_6" = "day_time_group")) %>%
    select(-previous_dtg_1, -previous_dtg_2, -previous_dtg_3, -previous_dtg_4, -previous_dtg_5, -previous_dtg_6) %>%
...
```{r}
train_volume = fread("volume(table 6)_training.csv")
train_volume %>% filter(direction == 0) %>% 
  select(-vehicle_type, -direction) %>%
  separate(time, into = c("date", "time"), sep = " ") %>%
  separate(time, into = c("hour", "minute", "second"), sep = ":") %>%
  mutate(date = as.Date(date), hour = as.numeric(hour), minute = as.numeric(minute)) %>% 
  select(-second) %>%
  group_by(tollgate_id, date, hour) %>%
  count()
...
```{r}
# output files
fwrite(train_links, file = "links_with_weather.csv", row.names = FALSE)
# fwrite(test_links, file = "test_links_with_weather.csv", row.names = FALSE)
fwrite(train_model, file = "train_model.csv", row.names = FALSE)
# fwrite(test_model, file = "test_model.csv", row.names = FALSE)
fwrite(test_model, file = "test_model.csv", row.names = FALSE)
```